    ...
    return (
        <div className="flex flex-col items-center">
            <div className="w-105 flex flex-col gap-10">
                <div>
                    <div className="text-gray-100/80 font-semibold20 mb-2">아이디</div>
                    <input
                        id="id"
                        value={formData.id}
                        onChange={onChange}
                ...
                <div>
                    <div className="text-gray-100/80 font-semibold20 mb-2">닉네임</div>
                    <input
                        id="nickname"
                ...
                <div>
                    <div className="text-gray-100/80 font-semibold20 mb-2">이메일</div>
                    <input
                        id="email"

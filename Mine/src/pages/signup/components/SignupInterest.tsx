...
export default function SignupInterests({ interests, onChange }: Props) {
  ...
  if (isLoading) {
    return <div className="text-white text-center">불러오는 중...</div>;
  }

  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col w-105">
        <div className="text-white font-semibold20 mb-6">
          관심사{" "}
          <span className="font-semibold16 text-white/70">
            최대 3개를 선택해 주세요.
          </span>
        </div>

        <div className="overflow-y-auto max-h-105 pr-1

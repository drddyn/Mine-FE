        ...
        <div className="relative min-h-screen bg-white flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-center w-105">
                ...
                <div className="flex flex-col gap-4 w-full">
                    <button
                        type="button"
                        className="w-full h-12.5 bg-main-default text-white font-medium16 rounded-[15px] shadow-[0_1px_4px_0_rgba(0,0,0,0.25)] hover:brightness-105 active:scale-[0.99] transition-all"
                    >
                        로그인
                    </button>
                    <button

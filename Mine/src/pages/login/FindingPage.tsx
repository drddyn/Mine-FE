            ...
            <div className="absolute inset-y-0 right-0 w-1/2 flex items-center justify-center z-10">
                <div className="w-110">
                    <div className="text-center mb-10">
                        <img src={logo} alt="Mine logo" className="mx-auto h-14.5 w-auto" />
                    </div>
                    ...
                    <div className="flex w-full mb-10 flex-col">
                        <div className="flex w-full">
                            <button
                                onClick={() => setTab('id')}
                                className="flex-1 text-center font-semibold16 pb-2.5 transition-colors"
                                style={{ color: tab === 'id' ? 'white' : 'var(--color-black-icon)' }}
                            >
                                아이디 찾기
                            </button>
                            <button
                                ...
                                className="flex-1 text-center font-semibold16 pb-2.5 transition-colors"
                                style={{ color: tab === 'password' ? 'white' : 'var(--color-black-icon)' }}
                            >
                                비밀번호 찾기
                            </button>
                        </div>
                        <div className="flex w-full">
                            <div className="flex-1 flex justify-center">
                                <div
                                    className="h-1 w-55 rounded-[15px] transition-colors"
                                    style={{ background: tab === 'id' ? 'white' : 'var(--color-black-icon)' }}
                                />
                            </div>
                            <div className="flex-1 flex justify-center">
                                <div
                                    className="h-1 w-55 rounded-[15px] transition-colors"
                                    style={{ background: tab === 'password' ? 'white' : 'var(--color-black-icon)' }}
                                />
                            </div>
                        </div>
                    </div>

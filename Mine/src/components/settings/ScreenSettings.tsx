...
export default function ScreenSettings() {
    return (
        <div className="w-136.5 h-36.5 flex gap-6.5">
            <button className="flex flex-col w-65 h-full rounded-2xl border border-lightborder bg-white items-center justify-center gap-3 text-black-whiteBoxOutline transition-colors duration-150 hover:bg-buttonbackgd hover:border-boldborder hover:text-lightborder">
